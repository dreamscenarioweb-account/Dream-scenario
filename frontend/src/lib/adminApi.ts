...
export const updateAlbum = (id: string, data: any) => api.put(`/admin/albums/${id}`, data);
...
export const addAlbumPhoto = (id: string, data: any) => api.post(`/admin/albums/${id}/photos`, data);
export const deletePhoto = (photoId: string) => api.delete(`/admin/photos/${photoId}`);
export const reorderPhotos = (id: string, photos: any[]) =>
  api.put(`/admin/albums/${id}/photos/reorder`, { photos });

// ── Album Categories ──────────────────────────────────────────────────────────
export const fetchCategories = () => api.get("/admin/album-categories");
export const createCategory = (data: any) => api.post("/admin/album-categories", data);
export const updateCategory = (id: string, data: any) => api.put(`/admin/album-categories/${id}`, data);
...
export const createHeroSlide = (data: any) => api.post("/admin/hero-slides", data);
export const updateHeroSlide = (id: string, data: any) => api.put(`/admin/hero-slides/${id}`, data);
...
export const createShowcaseItem = (data: any) => api.post("/admin/showcase", data);
export const updateShowcaseItem = (id: string, data: any) => api.put(`/admin/showcase/${id}`, data);
...
export const createTeamMember = (data: any) => api.post("/admin/team-members", data);
export const updateTeamMember = (id: string, data: any) => api.put(`/admin/team-members/${id}`, data);
...
export const createBlogPost = (data: any) => api.post("/admin/blog-posts", data);
export const updateBlogPost = (id: string, data: any) => api.put(`/admin/blog-posts/${id}`, data);
...
export const markQuoteRead = (id: string) => api.patch(`/admin/quote-requests/${id}/read`);
