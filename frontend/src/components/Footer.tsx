...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#232323] text-white/90">
        ...
        <StaggerReveal className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <StaggerItem>
            ...
            <div className="flex gap-4 mt-8">
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 hover:text-white transition-all duration-300" aria-label="Instagram">
                <Instagram size={24} />
              </a>
              <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 hover:text-white transition-all duration-300" aria-label="Facebook">
                <Facebook size={24} />
              </a>
              <a href="#" className="opacity-70 hover:opacity-100 hover:text-white transition-all duration-300" aria-label="YouTube">
                <Youtube size={24} />
              </a>
            </div>
          </StaggerItem>
